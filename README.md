<h1 align="center">Olá! Matheus aqui 👋</h1>
<h3 align="center">Desenvolvedor Web focado em SEO técnico e GEO (Generative Engine Optimization)</h3>

<p align="center">
Crio e desenvolvo sites, automatizo SEO técnico e otimizo conteúdo para IA generativa (ChatGPT, Perplexity, Google AI Overviews). Trabalho com sitemaps, scripts de automação e engenharia de prompts para IA.
</p>
...
- SEO técnico (schema.org, JSON-LD, canonical tags, Core Web Vitals)
- GEO — otimização de conteúdo para respostas de IA generativa
- Arquitetura de landing pages locais (SEO local escalável)
- Automação de auditorias e scripts de SEO
- Prototipagem rápida com **Lovable**
